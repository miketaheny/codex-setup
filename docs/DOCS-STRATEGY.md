...
| `docs/BRAND-GUIDELINES.md` | Current | Keep positioning, messaging, voice, visual identity, UI rules, launch surfaces, and public repo presentation guidance aligned with the product direction. |
