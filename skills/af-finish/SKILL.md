...
Do not run `af-claude-review` automatically from finish. Use it only on explicit request or from review/release workflows when an external model check is warranted.
